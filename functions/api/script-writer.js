...
export async function onRequestPost({ request, env }) {
  try {
    ...
    const lengthMap = { short: '1-2 минутын', medium: '3-5 минутын', long: '7-10 минутын' };
    const lengthName = lengthMap[length] || '3-5 минутын';

    const systemPrompt = `Чи контент бичигч. Монгол хэлээр ${typeName}-д зориулсан script бичнэ. Урт: ${lengthName} ярианы script (ойролцоогоор тохирох үгийн тоогоор).
Дараах бүтцээр бич:
- Hook (анхны 5-10 секундэд анхаарал татах)
- Үндсэн агуулга (тодорхой хэсэгт хуваагдсан)
